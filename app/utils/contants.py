...
POKEMON_TEXT_X1_OFFSET = 0  # Offset added to the left coordinate
POKEMON_TEXT_Y1_OFFSET = 0  # Offset added to the top coordinate
POKEMON_TEXT_X2_OFFSET = 0  # Offset subtracted from the right coordinate
POKEMON_TEXT_Y2_OFFSET = 0  # Offset subtracted from the bottom coordinate