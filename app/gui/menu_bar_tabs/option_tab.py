...
class OptionsTab:
    ...
    def open_options(self):
        ...
        save_screenshots = self.config.get("save_screenshots", CONFIG_SCREENSHOT_DEFAULT_OPTION)
        ...
        screenshot_path = self.config.get("screenshot_path", CONFIG_SCREENSHOT_DEFAULT_PATH)
        ...
        def save_config():
            try:
                self.config.set("screenshot_delay", int(delay_var.get()))
                self.config.set("save_screenshots", save_var.get())
                self.config.set("screenshot_path", screenshot_path_var.get())
