...
% Recolha de Imagens
\include{seccoes/recolha_de_imagens}

% Methodology / Work Done
\include{seccoes/etiquetagem}


% Treino do Modelo
\include{seccoes/treino_do_modelo}

% Data Augmentation
\include{seccoes/data_augmentation}

% Avaliação do Modelo
\include{seccoes/avaliacao_do_modelo}

% Implementação em Produção
\include{seccoes/implementacao_em_producao}
